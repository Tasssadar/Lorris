...
static inst_prototype instructions[] =
{
  ...
  //{"des",   0x940B, 0xFF0F, 1, NYI, NONE},  //data encryption, NYI
  //{"eicall",0x9519, 0xFFFF, 1, NONE, NONE}, // 22bit, NYI
    {"eijmp", 0x9419, 0xFFFF, 1, NONE, NONE},
    {"elpm",  0x95D8, 0xFFFF, 1, NONE, NONE},
    {"elpm",  0x9006, 0xFE0F, 1, REG_D5, NONE},
    {"elpm",  0x9007, 0xFE0F, 1, REG_D5, NONE},
    {"eor",   0x2400, 0xFC00, 1, REG_D5, REG_S5},
    {"fmul",  0x0308, 0xFF88, 1, REG_D3, REG_S3},
    {"fmuls", 0x0380, 0xFF88, 1, REG_D3, REG_S3},
    {"fmulsu",0x0388, 0xFF88, 1, REG_D3, REG_S3},
    {"icall", 0x9509, 0xFFFF, 1, NONE, NONE},
    {"ijmp",  0x9409, 0xFFFF, 1, NONE, NONE},
    {"in",    0xB000, 0xF800, 1, REG_D5, PORT_ALL},
    {"inc",   0x9403, 0xFE0F, 1, REG_D5, NONE},
    {"jmp",   0x940C, 0xFE0E, 2, ADDR22, NONE},
    {"lac",   0x4906, 0xFE0F, 1, REG_D5, NONE},
    {"las",   0x9205, 0xFE0F, 1, REG_D5, NONE},
    {"lat",   0x9207, 0xFE0F, 1, REG_D5, NONE},
    {"ld",    0x900C, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ld",    0x900D, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ld",    0x900E, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ld",    0x8008, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ld",    0x9009, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ld",    0x900A, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ld",    0x8000, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ld",    0x9001, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ld",    0x9002, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"ldd",   0x8008, 0xD208, 1, REG_D5, INDIR_SHIFT},
    {"ldd",   0x8000, 0xD208, 1, REG_D5, INDIR_SHIFT},
    {"ldi",   0xE000, 0xF000, 1, REG_D4, BYTE},
    {"lds",   0x9000, 0xFE0F, 2, REG_D5, WORD},
    {"lds",   0xA000, 0xF800, 1, REG_D4, BYTE_SIGNED},
    {"lpm",   0x95C8, 0xFFFF, 1, NONE, NONE},
    {"lpm",   0x9004, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"lpm",   0x9005, 0xFE0F, 1, REG_D5, INDIR_ADDR},
    {"lsl",   0x0C00, 0xFC00, 1, SHIFT_LEFT},
    {"lsr",   0x9406, 0xFE0F, 1, REG_D5, NONE},
    {"mov",   0x2C00, 0xFC00, 1, REG_D5, REG_S5},
    {"movw",  0x0100, 0xFF00, 1, WORD_D, WORD_S},
    {"mul",   0x9C00, 0xFC00, 1, REG_D5, REG_S5},
    {"muls",  0x0200, 0xFF00, 1, REG_D4, REG_S4},
    {"mulsu", 0x0300, 0xFF88, 1, REG_D4, REG_S4},
    {"neg",   0x9401, 0xFE0F, 1, REG_D5, NONE},
    {"nop",   0x0000, 0xFFFF, 1, NONE, NONE},
    {"or",    0x2800, 0xFC00, 1, REG_D5, REG_S5},
    {"ori",   0x6000, 0xF000, 1, REG_D4, BYTE},
    {"out",   0xB800, 0xF800, 1, PORT_ALL, REG_D5},
    {"pop",   0x900F, 0xFE0F, 1, REG_D5, NONE},
    {"push",  0x920F, 0xFE0F, 1, REG_D5, NONE},
    {"rcall", 0xD000, 0xF000, 1, ADDR_SHIFT12, NONE},
    {"ret",   0x9508, 0xFFFF, 1, NONE, NONE},
    {"reti",  0x9518, 0xFFFF, 1, NONE, NONE},
    {"rjmp",  0xC000, 0xF000, 1, ADDR_SHIFT12, NONE},
    {"rol",   0x1c00, 0xFC00, 1, SHIFT_LEFT},
    {"ror",   0x9407, 0xFE0F, 1, REG_D5, NONE},
    {"sbc",   0x0800, 0xFC00, 1, REG_D5, REG_S5},
    {"sbci",  0x4000, 0xF000, 1, REG_D4, BYTE},
    {"sbi",   0x9A00, 0xFF00, 1, PORT, BIT_SREG2},
    {"sbic",  0x9900, 0xFF00, 1, PORT, BIT_SREG2},
    {"sbis",  0x9B00, 0xFF00, 1, PORT, BIT_SREG2},
    {"sbiw",  0x9700, 0xFF00, 1, REG_D2, CONST_6},
    {"sbr",   0x6000, 0xF000, 1, REG_D4, BYTE},
    {"sbrc",  0xFC00, 0xFE08, 1, REG_D5, BIT_SREG2},
    {"sbrs",  0xFE00, 0xFE08, 1, REG_D5, BIT_SREG2},
    {"sec",   0x9408, 0xFFFF, 1, NONE, NONE},
    {"seh",   0x9458, 0xFFFF, 1, NONE, NONE},
    {"sei",   0x9478, 0xFFFF, 1, NONE, NONE},
    {"sen",   0x9428, 0xFFFF, 1, NONE, NONE},
    {"ser",   0xEF0F, 0xFF0F, 1, REG_D4, NONE},
    {"ses",   0x9448, 0xFFFF, 1, NONE, NONE},
    {"set",   0x9468, 0xFFFF, 1, NONE, NONE},
    {"sev",   0x9438, 0xFFFF, 1, NONE, NONE},
    {"sez",   0x9418, 0xFFFF, 1, NONE, NONE},
    {"sleep", 0x9588, 0xFFFF, 1, NONE, NONE}, //NYI
    //spm - self-programing - NYI
    {"st",    0x920C, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"st",    0x920D, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"st",    0x920E, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"st",    0x8208, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"st",    0x9209, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"st",    0x920A, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"std",   0x8208, 0xD208, 1, INDIR_SHIFT, REG_D5},
    {"st",    0x8200, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"st",    0x9201, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"st",    0x9202, 0xFE0F, 1, INDIR_ADDR, REG_D5},
    {"std",   0x8200, 0xD208, 1, INDIR_ADDR, REG_D5},
    {"sts",   0x9200, 0xFE0F, 2, ADDR22, REG_D5},
    {"sts",   0xA800, 0xF800, 1, REG_D4, BYTE_SIGNED},
    {"sub",   0x1800, 0xFC00, 1, REG_D5, REG_S5},
    {"subi",  0x5000, 0xF000, 1, REG_D4, BYTE},
    {"swap",  0x9402, 0xFE0F, 1, REG_D5, NONE},
